 ...
 */
inline std::string
streambufToString (const boost::asio::streambuf &buff)
{
 ...
 */
inline void
copyStringToStreambuf (const std::string &inputStr,
 ...
 */
inline void
moveStreambuf (boost::asio::streambuf &source, boost::asio::streambuf &target)
{
 ...
 */
inline void
copyStreambuf (boost::asio::streambuf &source, boost::asio::streambuf &target)
{
  auto bytes_copied = boost::asio::buffer_copy (
      target.prepare (source.size ()), source.data ());
  target.commit (bytes_copied);
 ...
 */
inline std::string
hexArrToStr (const unsigned char *data, std::size_t size)
{
...
hexToInt (const std::string &hexString)
{
 ...
 */
inline std::string
hexToASCII (const std::string &hex)
{
  std::string ascii;
...
strToHexArr (const std::string &hexStr)
{
 ...
 */
inline std::string
hexStreambufToStr (const boost::asio::streambuf &buff)
{
  return hexArrToStr (reinterpret_cast<const unsigned char *> (
 ...
 */
inline std::string
decode64 (const std::string &inputStr)
{
 ...
 */
inline std::string
encode64 (const std::string &inputStr)
{
  using namespace boost::archive::iterators;
  ...
  std::string encoded (base64Enc (inputStr.begin ()),
 ...
 */
inline BoolStr
aes256Encrypt (const std::string &plaintext, const std::string &key)
{
 ...
 */
inline BoolStr
aes256Decrypt (const std::string &ciphertext_with_iv, const std::string &key)
{
  ...
  result.ok = true;
  result.message = std::string (reinterpret_cast<char *> (plaintext.data ()),
                                plaintext_len);
 ...
 */
inline BoolStr
validateConfig (int argc, const char *argv[])
{
  ...
  try
    ...
    {
      result.message
          = std::string ("Error in 'log' block: ") + e.what () + "\n";
      return result;
    }
  ...
  try
    ...
    {
      result.message
          = std::string ("Error in 'server' block: ") + e.what () + "\n";
      return result;
    }
  ...
  try
    ...
    {
      result.message
          = std::string ("Error in 'agent' block: ") + e.what () + "\n";
      return result;
    }
